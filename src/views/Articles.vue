            ...
            <main class="site-main">
                <article class="hentry">
                    ...
                    <header class="entry-header">
                        <!-- 标题输出 -->
                        <h1 class="entry-title">{{blogDetail.blogTitle}}</h1>
                        <hr>
                        <div class="breadcrumbs">
                            <div id="crumbs">最后更新时间：{{blogDetail.releaseDate}}</div>
                        </div>
                    </header>
                    <!-- 正文输出 -->
                    <div class="entry-content" v-html="blogDetail.blogContent">
<!--                        <p>@[TOC]</p>-->
<!--                        <h4 id="引言：">引言：</h4>-->
                    ...
                    <section-title>
                        <footer class="post-footer">
                            ...
                            <div class="post-like">
                                ...
                                <span class="count">{{blogDetail.viewCount}}</span>
                            </div>
                            <!-- 分享按钮 -->
                            ...
                            <div class="post-tags">
                                ...
                                <router-link :to="`/category/${blogDetail.categoryId}`">{{blogDetail.categoryName}}</router-link>
                            </div>
                        </footer>
                    </section-title>
...
<script>
    ...
    import {fetchComment,fetchBlogDetail} from '../api'
    export default {
        name: 'articles',
        data(){
          return{
        ...
        methods: {
            //查询blog详情
            getBlogDetail(){
                let par = {blogId:this.$route.params.id}
                fetchBlogDetail(par).then(res=> {
